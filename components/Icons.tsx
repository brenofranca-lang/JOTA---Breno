...
export const GoalIcon: React.FC = () => (
     <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="mr-2 text-indigo-400">
        ...
        <path d="M20.5 10.5c.13.13.25.26.36.4a5 5 0 0 1-5.36 7.5c-1.34-.6-2.48-1.6-3.22-2.8"></path>
        <path d="M3.5 10.5c-.13.13-.25.26-.36.4a5 5 0 0 0 5.36 7.5c1.34-.6 2.48-1.6 3.22-2.8"></path>
    </svg>
);
